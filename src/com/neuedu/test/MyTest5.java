...
public class MyTest5 {
    public static void main(String[] args) {
       /* int a = 10;
         ...
         *    字符输出流 Writer
         * /
//        File file = new File("e:/东软培训/test.java");
...
//        try {
//            //append默认为false，表示添加进去的内容会覆盖原来的文件中的内容，append:true之后表示在原文件内容的基础上再追加内容
//            OutputStream outputStream = new FileOutputStream(file,true);  //产生异常 用try catch 捕获异常
//            String a = "asdfgh";           //流相当于在内存与资源之间架起一个管道
//            outputStream.write(a.getBytes());     //因为传的是字节流，所以要把a(字符串)转换成字节数组放入管道里
//            outputStream.flush();                 //把管道里的内容压入文件里
//            outputStream.close();
